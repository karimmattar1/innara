  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        metric: {
          happiness: "hsl(var(--accent-gold))",
          revenue: "hsl(var(--success))",
          time: "hsl(var(--primary))",
          requests: "hsl(271 76% 53%)",
          guests: "hsl(288 60% 58%)",
        },
        // Brand colors for direct access
        navy: {
          DEFAULT: "hsl(233 41% 16%)",
          dark: "hsl(233 41% 12%)",
          light: "hsl(233 41% 22%)",
        },
        // Bronze for accent elements
        gold: {
          DEFAULT: "hsl(34 42% 43%)",
          light: "hsl(34 42% 55%)",
          dark: "hsl(34 42% 35%)",
        },
      },
      ...
      boxShadow: {
        ...
        'glass-lg': '0 8px 32px -4px rgba(0, 0, 0, 0.15), 0 4px 16px -2px rgba(0, 0, 0, 0.05)',
        'navy': '0 4px 16px rgba(26, 29, 58, 0.3)',
        'navy-lg': '0 6px 24px rgba(26, 29, 58, 0.4)',
      ...
      keyframes: {
        ...
        "pulse-navy": {
          "0%, 100%": { boxShadow: "0 0 0 0 rgba(26, 29, 58, 0.4)" },
          "50%": { boxShadow: "0 0 0 8px rgba(26, 29, 58, 0)" },
        },
        shimmer: {
