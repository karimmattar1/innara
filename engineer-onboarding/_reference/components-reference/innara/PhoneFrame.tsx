...
export function PhoneFrame({ children }: PhoneFrameProps) {
  ...
  // Desktop: render children inside iPhone frame (single mount)
  return (
    <PhoneFrameContext.Provider value={true}>
      ...
      >
        ...
        >
          ...
          <div className="relative bg-black rounded-[42px] overflow-hidden w-full h-full">
            ...
            {/* Screen content area - overflow hidden to let children handle scroll */}
            <div
            ...
            >
              ...
              {/* Home indicator removed to avoid misalignment */}
            </div>
          </div>
        </div>
