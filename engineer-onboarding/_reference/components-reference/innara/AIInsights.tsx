...
import { Sparkles, TrendingUp, AlertTriangle, Lightbulb, Clock, Users, DollarSign, Star } from "lucide-react";
...
function generateManagerInsights(data: AnalyticsData): Insight[] {
  ...
  // Upsell: room service average ticket
  ...
  // Alert: SLA departments below target
  ...
  // Optimization: peak hours staffing
...
function generateStaffInsights(data: AnalyticsData): Insight[] {
  ...
  // Alert: open requests needing attention
  ...
  // Optimization: task type pattern
  ...
  // Upsell: satisfaction above threshold
