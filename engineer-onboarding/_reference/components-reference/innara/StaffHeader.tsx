...
export function StaffHeader() {
  ...
  const notifications = [
    { id: '1', message: 'New request from Room 412', time: '2m ago' },
    { id: '2', message: 'Request #1234 marked urgent', time: '8m ago' },
  ];
      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center">
            <InnaraLogo size="md" linkTo="/staff" />
          </div>
              ...
              <DropdownMenuTrigger asChild>
                <button className="flex items-center gap-3 hover:bg-secondary/30 rounded-xl px-2 py-1.5 transition-colors">
                  ...
                  <div className="hidden sm:block text-left">
                    <p className="text-sm font-medium">{staffProfile?.fullName || profile?.full_name || 'Staff'}</p>
