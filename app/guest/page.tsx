  ...
  return (
    <div className="flex flex-col h-full" style={{ border: '3px solid red' }}>
      ...
      <div className="flex-1 overflow-y-auto" style={{ border: '3px solid blue' }}>
        <div className="px-4 py-4 grid grid-cols-2 gap-3" style={{ backgroundColor: 'rgba(0,255,0,0.1)' }}>
          {allServices.map((service) => (
            <button
              key={service.value}
              onClick={() => onServiceClick(service.value)}
              className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-4 flex flex-col items-center justify-center gap-2 hover:bg-white/20 hover:border-gold/50 hover:scale-105 transition-all shadow-lg aspect-square"
            >
